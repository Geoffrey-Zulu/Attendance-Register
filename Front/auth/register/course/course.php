...
<div class="card dashboard-item mt-4">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>";
            echo "<button type='button' class='btn btn-link' data-toggle='modal' data-target='#addStudentModal' data-course-code='" . $row['course_code'] . "' data-course-name='" . $row['course_name'] . "'>";
